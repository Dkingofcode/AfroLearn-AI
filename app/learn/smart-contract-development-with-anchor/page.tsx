// pages/learn/smart-contract-development-with-anchor/page.tsx
"use client"
...
// Find the Anchor module
const anchorModule = courseModules.find((module) => module.slug === "smart-contract-development-with-anchor")

export default function AnchorSmartContractPage() {
  const { t } = useLanguage()
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <header className="mb-8">
          ...
          <h1 className="text-3xl font-bold mb-2">{anchorModule.title}</h1>
          <p className="text-muted-foreground mb-4">{anchorModule.description}</p>
          <div className="flex items-center gap-4 text-sm text-muted-foreground">
            <span>{anchorModule.lessons.length} lessons</span>
            <span>•</span>
            <span>{anchorModule.duration}</span>
          </div>
        </header>

        {/* Lessons List */}
        <div className="space-y-6">
          {anchorModule.lessons.map((lesson) => (
                          ...
                          <Card key={exercise.id} className="p-4">
                            ...
                            <Button
                              ...
                              onClick={() => {
                                ...
                                // Example: router.push(`/learn/smart-contract-development-with-anchor/practice/${lesson.id}/${exercise.id}`)
                              }}
                            >
                              Start Exercise
