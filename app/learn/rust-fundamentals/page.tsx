// pages/learn/rust-fundamentals/page.tsx
"use client"
    ...
    <div className="min-h-screen bg-background">
      <div className="container mx-auto px-4 py-8">
        ...
        <header className="mb-8">
          ...
          <p className="text-muted-foreground mb-4">{rustModule.description}</p>
                          ...
                          <Card key={exercise.id} className="p-4">
                            ...
                            <Button
                              ...
                              onClick={() => {
                                ...
                                // Example: router.push(`/learn/rust-fundamentals/practice/${lesson.id}/${exercise.id}`)
                              }}
                            >
                              Start Exercise
